            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="<?= base_url() ?>stafflist">Cafe Staff List</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url() ?>add-staff"><?= $title ?></a></li>
                    </ol>
                </div>
            </div> <!--end::Row-->
        </div> <!--end::Container-->
                ...
                <div class="col-12"> <!--begin::Form Validation-->
                    <div class="card card-info card-outline mb-4"> <!--begin::Header-->
                        <div class="card-header">
                            <div class="card-title">Register form for Cafe Staff</div>
                        ...
                        <form class="needs-validation" novalidate> <!--begin::Body-->
                            <div class="card-body"> <!--begin::Row-->
                                <div class="row g-3 pb-3"> <!--begin::Col-->
                                    ...
                                    <div class="col-md-6"> <label for="validationCustom04" class="form-label">Cafe Name</label> <select class="form-select" id="validationCustom04" required>
                                    ...
                                    <div class="col-md-6"> <label for="validationCustom03" class="form-label">Email</label> <input type="text" class="form-control" id="validationCustom03" required>
                                        <div class="invalid-feedback">
                                            Please provide a valid email.
                                        </div>
                                    </div> <!--end::Col--> <!--begin::Col-->
                                    <div class="col-md-6"> <label for="validationCustom03" class="form-label">Password</label> <input type="text" class="form-control" id="validationCustom03" required>
                                        <div class="invalid-feedback">
                                            Please provide a valid email.
                                        </div>
                                    </div> <!--end::Col-->
