            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="<?= base_url() ?>studentlist">Student List</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url() ?>add-student"><?= $title ?></a></li>
                    </ol>
                </div>
            </div> <!--end::Row-->
        </div> <!--end::Container-->
                ...
                <div class="col-12"> <!--begin::Form Validation-->
                    <div class="card card-info card-outline mb-4"> <!--begin::Header-->
                        <div class="card-header">
                            <div class="card-title">Register form for Student</div>
